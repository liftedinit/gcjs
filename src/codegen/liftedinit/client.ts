...
import * as liftedinitGhostcloudV1TxRegistry from "./ghostcloud/v1/tx.registry";
import * as liftedinitGhostcloudV1TxAmino from "./ghostcloud/v1/tx.amino";
export const liftedinitAminoConverters = {
  ...liftedinitGhostcloudV1TxAmino.AminoConverter
};
export const liftedinitProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...liftedinitGhostcloudV1TxRegistry.registry];
